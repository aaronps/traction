...
public class CollisionMask64
{
	...
	public int getWidth()  { return bm_width; }
	public int getHeight() { return bm_height; }
	
	public void fromBitmap(final Bitmap bitmap)
	{
	...
	public boolean collidesWith( final int x, int y, int h,

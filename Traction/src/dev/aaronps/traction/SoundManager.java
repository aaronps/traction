...
{
    private static final NoSoundPlayer nosound_player = new NoSoundPlayer();
    private static final NormalPlayer normal_player = new NormalPlayer();
    ...
    {
        @Override public void play(final int soundId) {}
        @Override public boolean activate() { return true; }
        @Override public void deactivate() { }
        @Override public boolean load(final Context context) { return true; } 
    }
